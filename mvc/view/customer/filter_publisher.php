<div class="panel">
    <div class="panel-heading">
        <ul class="breadcrumb">
            ...
            <li><a href="/DoAnTH02/Filter/according_to_publisher/id=1/page=1/">Filter</a></li>
            <li><a href="/DoAnTH02/Filter/according_to_publisher/id=<?php echo $this->data["selected_publisher"]->publisher_id; ?>/page=1/"><?php echo $this->data["selected_publisher"]->name; ?></a></li>
        </ul>
    </div>
                    ...
                    <div>
                        <ul class="pagination">
                            ...
                            for ($n = 1; $n <= $this->data["number_of_page"]; $n++) {
                                if ($n != $this->data["page"]) { ?>
                                    <li><a href="/DoAnTH02/Filter/according_to_publisher/id=<?php echo $this->data["id"]; ?>/page=<?php echo $n; ?>"> <?php echo $n; ?> </a></li>;
                                <?php
                                } else {
                                ?>
                                    <li class="active"><a href="/DoAnTH02/Filter/according_to_publisher/id=<?php echo $this->data["id"]; ?>/page=<?php echo $n; ?>"> <?php echo $n; ?> </a></li>
                            <?php
                                }
                            }
                            ?>
                ...
                <ul class="list-group">
                    <?php foreach ($this->data["publishers"] as $publishers) { ?>
                        <li class="list-group-item">
                            <a href="/DoAnTH02/Filter/according_to_publisher/id=<?php echo $publishers->publisher_id ?>/page=1"><?php echo $publishers->name ?></a>
                            <span class="badge">
                                <?php
