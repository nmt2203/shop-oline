<div class="panel">
    <div class="panel-heading">
        <ul class="breadcrumb">
            ...
            <li><a href="/DoAnTH02/Filter/according_to_author/id=1/page=1/">Filter</a></li>
            <li><a href="/DoAnTH02/Filter/according_to_author/id=<?php echo $this->data["selected_author"]->author_id; ?>/page=1/"><?php echo $this->data["selected_author"]->name; ?></a></li>
        </ul>
    </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                <div class="product-grid">
                                    ...
                                    <div class="product-content">
                                            ...
                                            <?php if ($books->coupon_id == null) {
                                                ...
                                                foreach ($this->data["coupons"] as $coupons) {
                                                    if ($books->coupon_id == $coupons->coupon_id) {
                                                        ...
                                                        echo "<p style='color:red;float: left;padding-left: 10px'> " . $sale . "<small>vnd</small></p>" . "<span style='text-decoration-line:line-through'> " . $books->price . "<small>vnd</small> </span>";
                                                    }
                                                }
                                            }
                                            ?>
                                        ...
                                        <div style="text-align: center"><a class="add-to-cart"  onclick="onAddCart(<?php echo $books->book_id; ?>);" href="">+ Add To Cart</a></div>
                                    </div>
                                </div>
                            </div>
                        <?php
                    ...
                    <div>
                        <ul class="pagination">
                            ...
                            for ($n = 1; $n <= $this->data["number_of_page"]; $n++) {
                                if ($n != $this->data["page"]) { ?>
                                    <li><a href="/DoAnTH02/Filter/according_to_author/id=<?php echo $this->data["id"]; ?>/page=<?php echo $n; ?>"> <?php echo $n; ?> </a></li>;
                                <?php
                                } else {
                                ?>
                                    <li class="active"><a href="/DoAnTH02/Filter/according_to_author/id=<?php echo $this->data["id"]; ?>/page=<?php echo $n; ?>"> <?php echo $n; ?> </a></li>
                            <?php
                                }
                            }
                            ?>
